...
export const { config, createTheme, css, getCssText, globalCss, styled, theme, keyframes } =
  createStitches({
    theme: {
      ...
      colors: {
        bgPrimary: '#282c34',
        bgPrimaryLight: '#424a5a',
        textPrimary: '#282c34',
        textPrimaryLight: '#6e7990',
        textSecondary: '#fff',
        textSecondaryLight: 'rgb(192, 255, 233)',

        bgPrimaryTpCover: 'rgba(40, 44, 52, 0.5)',
        bgPrimaryTp: 'rgba(40, 44, 52, 0.8)',
        bgPrimaryTpLight: 'rgba(66, 74, 90, 0.8)',
        bgSecondary: '#fff',
        bgSecondaryLight: 'rgba(192, 255, 233, 0.3)',
        logoColor: '#40ac9c',
